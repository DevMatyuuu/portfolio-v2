  ...
  return (
    <div className='flex flex-col items-center text-[#214062] font-besley py-10 h-auto'>
        ...
        <div className='flex items-center gap-10 text-white'>
            <MagneticIcon >
              <div className='bg-[#214062] h-28 w-28 flex justify-center items-center rounded-full shadow-2xl' data-aos='zoom-in' data-aos-duration="1000" data-aos-once="true" data-aos-delay="1200">
                <img src={sassLogo} className='size-14'/>
              </div>
            </MagneticIcon>
            <MagneticIcon>
              <div className='bg-[#214062] h-32 w-32 flex justify-center items-center rounded-full shadow-2xl' data-aos='zoom-in' data-aos-duration="1000" data-aos-once="true" data-aos-delay="1000">
                <img src={tsLogo} className='size-16'/>
              </div>
            </MagneticIcon>
            <MagneticIcon>
              <div className='bg-[#214062] h-40 w-40 flex justify-center items-center rounded-full shadow-2xl'  data-aos='zoom-in' data-aos-duration="1000" data-aos-once="true" data-aos-delay="800">
               <img src={reactLogo} className='size-24'/>
              </div>
            </MagneticIcon>
            <div className='-z-50 relative px-8 bg-[#214062] w-[280px] rounded-2xl h-[420px] shadow-2xl' data-aos='zoom-in' data-aos-duration="1000" data-aos-once="true" data-aos-delay="400">
