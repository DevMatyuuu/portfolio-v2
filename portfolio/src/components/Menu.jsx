...
export default function Menu() {
  return (
    <div className='flex justify-center py-20 px-48 my-20 text-[#2E5A88]'>
        <div className='grid grid-cols-3 gap-8 w-full h-[700px]'>
            <div className='flex flex-col col-span-1 row-span-4 shadow-xl bg-[#F0EAE2] border border-[#2E5A88]/30 rounded-3xl hover:scale-105 duration-700 cursor-pointer hover:shadow-2xl'>
                <img src={proj1} alt='project-1'/>
            </div>
            <div className='flex flex-col relative col-span-2 row-span-2 shadow-xl bg-[#F0EAE2] border border-[#2E5A88]/30 rounded-3xl hover:scale-105 duration-700 cursor-pointer hover:shadow-2xl'>
            ...
            <div className='flex flex-col relative col-span-1 row-span-2 shadow-xl bg-[#F0EAE2] border border-[#2E5A88]/30 rounded-3xl hover:scale-105 duration-700 cursor-pointer hover:shadow-2xl'>
